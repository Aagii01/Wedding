...
const schedule = [
  ...
  { time: "17:30", label: "Хурмын танхимд суудал эзлэх", desc: "Зочид байраа эзлэн, ёслолд бэлтгэнэ" },
  { time: "18:00", label: "Эхлэл шторк, хурмын нээлт", desc: "Хурмын нээлтийн үйл ажиллагаа" },
  { time: "18:20", label: "Хурмын 1-р хэсэг", desc: "Хосууд орж ирэх" },
  { time: "18:40", label: "Хүндэтгэлийн зоог", desc: "Баярын зоог барина" },
  { time: "20:20", label: "Хурмын 2-р хэсэг", desc: "Хурмын 2-р хэсэг эхлэнэ" },
